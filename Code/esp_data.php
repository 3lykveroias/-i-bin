/**
 * This PHP script connects to a MySQL server and retrieves data from a table named SensorData.
 * The retrieved data is displayed in an HTML table.
 * The code is based on and customized from Rui Santos' existing code at https://github.com/RuiSantosdotme/Cloud-Weather-Station-ESP32-ESP8266/blob/master/code/esp-weather-station.php
 *
